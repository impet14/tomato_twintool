...
if __name__ == '__main__':
    ...
    parser.add_argument('-num-w', '--num-workers', dest='num_workers', type=int,
                        default=1, help='Number of workers.') #4
    parser.add_argument('-q-size', '--queue-size', dest='queue_size', type=int,
                        default=1, help='Size of the queue.') #5
    ...
    while True:
        ...
        color_rsframe = rsframe.get_color_frame()
        if not color_rsframe:
            continue
        frame = np.asanyarray(color_rsframe.get_data())
        # Show images
